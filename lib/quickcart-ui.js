...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['hogan.js', 'quickcart'], function (Hogan, quickcart) {
      return factory(Hogan, quickcart);
    });
  }
  else if (typeof module !== 'undefined' && module.exports && require) {
    module.exports = factory(require('hogan.js'), require('quickcart'));
  }
  else {
    root.QuickCart = factory(root.Hogan, root.Cart);
  }
}(this, function (Hogan, Cart) {
  'use strict';
  ...
  QuickCart.prototype._initModel = function() {
    ...
    if (savedState) {
      ...
      if (savedState.meta) {
        for (var k in savedState.meta) {
          this.model.options.meta[k] = savedState.meta[k];
        }
      }
    }
  };
  ...
  // expose QuickCartView
  QuickCart.QuickCartView = QuickCartView;
